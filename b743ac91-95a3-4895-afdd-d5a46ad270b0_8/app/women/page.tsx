      ...
      <div className="relative py-24 px-4 lg:px-8">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            <span className="bg-pink-500/20 backdrop-blur-sm text-pink-800 px-6 py-3 rounded-full text-sm font-medium">
              Feminine Design
            </span>
            <span className="bg-purple-500/20 backdrop-blur-sm text-purple-800 px-6 py-3 rounded-full text-sm font-medium">
              Superior Comfort
            </span>
            <span className="bg-rose-500/20 backdrop-blur-sm text-rose-800 px-6 py-3 rounded-full text-sm font-medium">
              Performance Ready
            </span>
          </div>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-4 sm:mb-0">Women's Products</h2>
                <select
                  value={sortBy}
