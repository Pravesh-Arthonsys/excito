          ...
          <div key={product.id} className="group cursor-pointer">
            ...
            <div className="mt-4">
              ...
              <div className="flex items-center gap-2">
                ...
                {product.original_price && <span className="text-sm text-gray-500 line-through">&#8377;{Number(product.original_price).toLocaleString()}</span>}
              </div>
            </div>
          </div>
        ))}
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl shadow-xl p-6 max-w-sm w-full">
            <div className="flex justify-between items-start mb-4">
              ...
              <button onClick={() => setQuickAdd(null)} className="text-gray-400 hover:text-gray-600 cursor-pointer"><i className="ri-close-line text-xl"></i></button>
            </div>
            <div className="mb-4">
